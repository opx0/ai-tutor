...
const staticArrayViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Static array of size 5: [10, 20, 30, 40, _]. Size=4, capacity=5. Read/Write any index in O(1) via the address formula.',
      elements: [
        { type: 'array', id: 'arr', label: 'Static Array (capacity 5)', items: [
          { value: '10', state: 'done' }, { value: '20', state: 'done' }, { value: '30', state: 'done' }, { value: '40', state: 'done' }, { value: '_', state: 'default' },
        ]},
        { type: 'variable', id: 'v-size', name: 'size', value: '4', state: 'default' },
        { type: 'variable', id: 'v-cap', name: 'capacity', value: '5', state: 'default' },
        { type: 'log', id: 'log', lines: [{ text: 'arr = [10, 20, 30, 40, _]. Read/Write O(1)', kind: 'info' }] },
      ],
    },
    {
      message: 'INSERT 25 at index 2: Must shift elements [2..3] one position RIGHT to make room. This is O(n) — the costly part of arrays.',
      elements: [
        { type: 'array', id: 'arr', label: 'Before insert at index 2', items: [
          { value: '10', state: 'done' }, { value: '20', state: 'done' }, { value: '30', state: 'comparing' }, { value: '40', state: 'comparing' }, { value: '_', state: 'default' },
        ]},
    ...
    {
      message: 'Shift right (work backwards!): arr[4]=arr[3]=40, arr[3]=arr[2]=30. Then arr[2]=25. Done! Shifted 2 elements.',
      elements: [
        { type: 'array', id: 'arr', label: 'After insert', items: [
          { value: '10', state: 'done' }, { value: '20', state: 'done' }, { value: '25', state: 'highlight' }, { value: '30', state: 'active' }, { value: '40', state: 'active' },
        ]},
        { type: 'variable', id: 'v-size', name: 'size', value: '5', state: 'error', description: 'FULL!' },
        { type: 'log', id: 'log', lines: [
    ...
    {
      message: 'Array is FULL (size==capacity==5). Cannot insert more — the static array limitation. Now DELETE index 1 (value 20)...',
      elements: [
        { type: 'array', id: 'arr', label: 'Static Array — FULL', items: [
          { value: '10', state: 'done' }, { value: '20', state: 'error' }, { value: '25', state: 'comparing' }, { value: '30', state: 'comparing' }, { value: '40', state: 'comparing' },
        ]},
        { type: 'variable', id: 'v-idx', name: 'deleteAt', value: '1', state: 'active' },
        { type: 'log', id: 'log', lines: [
          { text: 'Delete arr[1]=20. Shift arr[2..4] LEFT', kind: 'call' },
        ] },
      ],
    },
    {
      message: 'Shift left: arr[1]=25, arr[2]=30, arr[3]=40. Size→4. Delete=O(n) worst, O(1) if last element.',
      elements: [
        { type: 'array', id: 'arr', label: 'After delete', items: [
          { value: '10', state: 'done' }, { value: '25', state: 'active' }, { value: '30', state: 'active' }, { value: '40', state: 'active' }, { value: '_', state: 'default' },
        ]},
...
const variableWindowViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Find longest substring without repeating characters in "abcabcbb". Two pointers: left and right. A hash set tracks chars in the window.',
      elements: [
        { type: 'array', id: 'arr', label: 'String', items: [
          { value: 'a', state: 'active' }, { value: 'b', state: 'default' }, { value: 'c', state: 'default' },
          { value: 'a', state: 'default' }, { value: 'b', state: 'default' }, { value: 'c', state: 'default' },
          { value: 'b', state: 'default' }, { value: 'b', state: 'default' },
        ]},
        { type: 'variable', id: 'v-l', name: 'left', value: '0', state: 'active' },
    ...
    },
    {
      ...
      elements: [
        { type: 'array', id: 'arr', label: 'String', items: [
          { value: 'a', state: 'active' }, { value: 'b', state: 'active' }, { value: 'c', state: 'active' },
          { value: 'a', state: 'default' }, { value: 'b', state: 'default' }, { value: 'c', state: 'default' },
          { value: 'b', state: 'default' }, { value: 'b', state: 'default' },
        ]},
        { type: 'variable', id: 'v-l', name: 'left', value: '0', state: 'active' },
    ...
    {
      message: 'right=3, char "a" already in set! Window invalid. SHRINK: remove s[left]="a", left=1. Now "bca" is valid again.',
      elements: [
        { type: 'array', id: 'arr', label: 'String', items: [
          { value: 'a', state: 'error' }, { value: 'b', state: 'active' }, { value: 'c', state: 'active' },
          { value: 'a', state: 'comparing' }, { value: 'b', state: 'default' }, { value: 'c', state: 'default' },
          { value: 'b', state: 'default' }, { value: 'b', state: 'default' },
        ]},
        { type: 'variable', id: 'v-l', name: 'left', value: '1', state: 'active' },
        { type: 'variable', id: 'v-r', name: 'right', value: '3', state: 'active' },
    ...
    {
      message: 'Continue expanding. right=4: "b" in set → shrink left to 2. right=5: "c" in set → shrink left to 3. Window = "abc" [3..5], best stays 3.',
      elements: [
        { type: 'array', id: 'arr', label: 'String', items: [
          { value: 'a', state: 'visited' }, { value: 'b', state: 'visited' }, { value: 'c', state: 'visited' },
          { value: 'a', state: 'active' }, { value: 'b', state: 'active' }, { value: 'c', state: 'active' },
          { value: 'b', state: 'default' }, { value: 'b', state: 'default' },
        ]},
    ...
    {
      message: 'right=6: "b" dup. Shrink past it. right=7: "b" dup again. Done! Answer = 3 ("abc"). O(n): each char enters and leaves window at most once.',
      elements: [
        { type: 'array', id: 'arr', label: 'String', items: [
          { value: 'a', state: 'visited' }, { value: 'b', state: 'visited' }, { value: 'c', state: 'visited' },
          { value: 'a', state: 'visited' }, { value: 'b', state: 'visited' }, { value: 'c', state: 'visited' },
          { value: 'b', state: 'done' }, { value: 'b', state: 'done' },
        ]},
...
const doublyLinkedListViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Doubly linked list: each node has BOTH next and prev pointers. Unlike singly linked lists, we can traverse backwards and delete any node in O(1).',
      elements: [
        { type: 'graph', id: 'dll', label: 'Doubly Linked List', layout: 'linear',
          nodes: [
            { id: 'n1', value: '10', state: 'default' },
            { id: 'n2', value: '20', state: 'default' },
            { id: 'n3', value: '30', state: 'default' },
        ...
        { type: 'log', id: 'log', lines: [{ text: '10 ⇄ 20 ⇄ 30. Each node knows both neighbors.', kind: 'info' }] },
      ],
    },
    {
      message: 'INSERT 15 after node 10: new.next=20, new.prev=10, 10.next=new, 20.prev=new. Four pointer updates, O(1).',
      elements: [
        { type: 'graph', id: 'dll', label: 'After inserting 15', layout: 'linear',
          nodes: [
            { id: 'n1', value: '10', state: 'active' },
            { id: 'new', value: '15', state: 'highlight' },
    ...
    {
      message: 'DELETE node 20: node.prev.next = node.next, node.next.prev = node.prev. Only 2 pointer updates! O(1) — no need to find predecessor.',
      elements: [
        { type: 'graph', id: 'dll', label: 'After deleting 20', layout: 'linear',
          nodes: [
            { id: 'n1', value: '10', state: 'done' },
            { id: 'new', value: '15', state: 'active' },
            { id: 'n3', value: '30', state: 'done' },
...
const queueViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Queue is FIFO: First In, First Out. Like a line at a store. enqueue adds to back, dequeue removes from front.',
      elements: [
    ...
    {
      message: 'enqueue(10), enqueue(20), enqueue(30). Elements enter at the back. Front of queue is 10.',
      elements: [
        { type: 'array', id: 'q', label: 'Queue (front → back)', items: [
          { value: '10', state: 'active' }, { value: '20', state: 'done' }, { value: '30', state: 'done' },
        ]},
        { type: 'variable', id: 'v-front', name: 'front', value: '10', state: 'active', description: 'next out' },
    ...
    {
      message: 'dequeue() returns 10 (front). FIFO: whoever entered first leaves first. Now front=20.',
      elements: [
        { type: 'array', id: 'q', label: 'Queue (front → back)', items: [
          { value: '20', state: 'active' }, { value: '30', state: 'done' },
        ]},
    ...
    {
      message: 'enqueue(40), dequeue() returns 20. Queue: [30, 40]. Queue is essential for BFS — it ensures level-by-level exploration.',
      elements: [
        { type: 'array', id: 'q', label: 'Queue (front → back)', items: [
          { value: '30', state: 'active' }, { value: '40', state: 'done' },
        ]},
...
const quickSortViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Quick Sort on [3, 6, 2, 7, 1]. Pick last element as pivot (1). Partition: everything < 1 goes left, > 1 goes right.',
      elements: [
        { type: 'array', id: 'arr', label: 'Array', items: [
          { value: '3', state: 'default' }, { value: '6', state: 'default' }, { value: '2', state: 'default' },
          { value: '7', state: 'default' }, { value: '1', state: 'highlight' },
        ]},
        { type: 'variable', id: 'v-pivot', name: 'pivot', value: '1', state: 'highlight' },
        { type: 'variable', id: 'v-i', name: 'i', value: '0', state: 'active', description: 'boundary' },
        { type: 'log', id: 'log', lines: [
    ...
    {
      message: 'Scan j=0..3: 3>1, 6>1, 2>1, 7>1 — nothing < pivot. i stays at 0. No swaps during scan.',
      elements: [
        { type: 'array', id: 'arr', label: 'After scan (no swaps)', items: [
          { value: '3', state: 'comparing' }, { value: '6', state: 'comparing' }, { value: '2', state: 'comparing' },
          { value: '7', state: 'comparing' }, { value: '1', state: 'highlight' },
        ]},
        { type: 'variable', id: 'v-pivot', name: 'pivot', value: '1', state: 'highlight' },
    ...
    {
      message: 'Swap pivot (1) with arr[i=0] (3). Pivot 1 is now at its FINAL sorted position (index 0). Left=[], Right=[6,2,7,3].',
      elements: [
        { type: 'array', id: 'arr', label: 'After partition', items: [
          { value: '1', state: 'done' }, { value: '6', state: 'active' }, { value: '2', state: 'active' },
          { value: '7', state: 'active' }, { value: '3', state: 'active' },
        ]},
        { type: 'variable', id: 'v-pivot', name: 'pivot pos', value: '0', state: 'done', description: 'FINAL' },
        { type: 'log', id: 'log', lines: [
    ...
    {
      message: 'Recurse on [6, 2, 7, 3]. Pivot=3. Scan: 6>3, 2<3→swap(arr[1],arr[1])→i=2, 7>3. Swap pivot: [2, 3, 7, 6].',
      elements: [
        { type: 'array', id: 'arr', label: 'Partitioning right half', items: [
          { value: '1', state: 'done' }, { value: '2', state: 'active' }, { value: '3', state: 'done' },
          { value: '7', state: 'active' }, { value: '6', state: 'active' },
        ]},
    ...
    {
      message: 'Continue: [7, 6], pivot=6. 7>6. Swap: [6, 7]. Done! [1, 2, 3, 6, 7]. Average O(n log n), worst O(n²) with bad pivots.',
      elements: [
        { type: 'array', id: 'arr', label: 'Sorted!', items: [
          { value: '1', state: 'done' }, { value: '2', state: 'done' }, { value: '3', state: 'done' },
...
const bucketSortViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Bucket Sort: values in [0, 10). Create 5 buckets for ranges [0-2), [2-4), [4-6), [6-8), [8-10). Input: [3, 7, 1, 9, 4, 2, 8, 5].',
      elements: [
        { type: 'array', id: 'input', label: 'Input', items: [
          { value: '3', state: 'default' }, { value: '7', state: 'default' }, { value: '1', state: 'default' },
          { value: '9', state: 'default' }, { value: '4', state: 'default' }, { value: '2', state: 'default' },
    ...
    {
      message: 'Distribute: 3→B1, 7→B3, 1→B0, 9→B4, 4→B2, 2→B1, 8→B4, 5→B2. Each element goes to its bucket.',
      elements: [
        { type: 'array', id: 'b0', label: 'Bucket 0 [0-2)', items: [{ value: '1', state: 'active' }] },
        { type: 'array', id: 'b1', label: 'Bucket 1 [2-4)', items: [{ value: '3', state: 'active' }, { value: '2', state: 'active' }] },
        { type: 'array', id: 'b2', label: 'Bucket 2 [4-6)', items: [{ value: '4', state: 'active' }, { value: '5', state: 'active' }] },
        { type: 'array', id: 'b3', label: 'Bucket 3 [6-8)', items: [{ value: '7', state: 'active' }] },
        { type: 'array', id: 'b4', label: 'Bucket 4 [8-10)', items: [{ value: '9', state: 'active' }, { value: '8', state: 'active' }] },
        { type: 'log', id: 'log', lines: [{ text: 'Distributed into 5 buckets — O(n)', kind: 'swap' }] },
      ],
    },
    {
      message: 'Sort each bucket individually (insertion sort — small buckets). Then concatenate all buckets in order.',
      elements: [
        { type: 'array', id: 'b0', label: 'Bucket 0 ✓', items: [{ value: '1', state: 'done' }] },
        { type: 'array', id: 'b1', label: 'Bucket 1 ✓', items: [{ value: '2', state: 'done' }, { value: '3', state: 'done' }] },
        { type: 'array', id: 'b2', label: 'Bucket 2 ✓', items: [{ value: '4', state: 'done' }, { value: '5', state: 'done' }] },
        { type: 'array', id: 'b3', label: 'Bucket 3 ✓', items: [{ value: '7', state: 'done' }] },
        { type: 'array', id: 'b4', label: 'Bucket 4 ✓', items: [{ value: '8', state: 'done' }, { value: '9', state: 'done' }] },
        { type: 'log', id: 'log', lines: [
    ...
    {
      message: 'Result: [1, 2, 3, 4, 5, 7, 8, 9]. O(n+k) average. Breaks the O(n log n) barrier because we don\'t compare all pairs!',
      elements: [
        { type: 'array', id: 'result', label: 'Sorted!', items: [
          { value: '1', state: 'done' }, { value: '2', state: 'done' }, { value: '3', state: 'done' },
          { value: '4', state: 'done' }, { value: '5', state: 'done' }, { value: '7', state: 'done' },
          { value: '8', state: 'done' }, { value: '9', state: 'done' },
        ]},
        { type: 'log', id: 'log', lines: [
...
const searchRangeViz: VisualizationBlock = {
  ...
  steps: [
    {
      message: 'Find FIRST occurrence of 5 in [1, 3, 5, 5, 5, 8, 9]. Standard binary search would find index 3. But 2 is earlier!',
      elements: [
        { type: 'array', id: 'arr', label: 'Sorted Array', items: [
          { value: '1', state: 'default' }, { value: '3', state: 'default' }, { value: '5', state: 'default' },
          { value: '5', state: 'comparing' }, { value: '5', state: 'default' }, { value: '8', state: 'default' }, { value: '9', state: 'default' },
        ]},
        { type: 'variable', id: 'v-lo', name: 'lo', value: '0', state: 'active' },
        { type: 'variable', id: 'v-hi', name: 'hi', value: '6', state: 'active' },
        { type: 'variable', id: 'v-mid', name: 'mid', value: '3', state: 'comparing' },
    ...
    {
      message: 'Found 5 at index 3. Save result=3. But there might be an earlier 5! Set hi=mid-1=2 to keep searching LEFT.',
      elements: [
        { type: 'array', id: 'arr', label: 'Sorted Array', items: [
          { value: '1', state: 'active' }, { value: '3', state: 'active' }, { value: '5', state: 'active' },
          { value: '5', state: 'done' }, { value: '5', state: 'visited' }, { value: '8', state: 'visited' }, { value: '9', state: 'visited' },
        ]},
        { type: 'variable', id: 'v-lo', name: 'lo', value: '0', state: 'active' },
    ...
    {
      message: 'lo=2, hi=2, mid=2. arr[2]=5 == target! Save result=2. Set hi=1. Now lo>hi → stop. First occurrence = index 2!',
      elements: [
        { type: 'array', id: 'arr', label: 'Sorted Array', items: [
          { value: '1', state: 'visited' }, { value: '3', state: 'visited' }, { value: '5', state: 'done' },
          { value: '5', state: 'done' }, { value: '5', state: 'visited' }, { value: '8', state: 'visited' }, { value: '9', state: 'visited' },
        ]},
        { type: 'variable', id: 'v-lo', name: 'lo', value: '2', state: 'done' },
        { type: 'variable', id: 'v-hi', name: 'hi', value: '1', state: 'done', description: 'lo > hi = DONE' },
...
export const basicPhases: DemoPhase[] = [
  {
    id: 'phase-1', phase: 1, title: 'Arrays — From Zero to Mastery',
  ...
  },
  {
    ...
    leetcode: [
      ...
      { id: 76, title: 'Minimum Window Substring', url: 'https://leetcode.com/problems/minimum-window-substring/', tag: 'Variable Window' },
      ...
      { id: 11, title: 'Container With Most Water', url: 'https://leetcode.com/problems/container-with-most-water/', tag: 'Two Pointers' },
      { id: 303, title: 'Range Sum Query', url: 'https://leetcode.com/problems/range-sum-query-immutable/', tag: 'Prefix Sum' },
      { id: 560, title: 'Subarray Sum Equals K', url: 'https://leetcode.com/problems/subarray-sum-equals-k/', tag: 'Prefix Sum + Hash' },
    ],
  },
  {
    ...
    leetcode: [
      ...
      { id: 21, title: 'Merge Two Sorted Lists', url: 'https://leetcode.com/problems/merge-two-sorted-lists/', tag: 'Linked List' },
      { id: 143, title: 'Reorder List', url: 'https://leetcode.com/problems/reorder-list/', tag: 'Linked List' },
      { id: 141, title: 'Linked List Cycle', url: 'https://leetcode.com/problems/linked-list-cycle/', tag: 'Fast/Slow' },
      { id: 19, title: 'Remove Nth Node From End', url: 'https://leetcode.com/problems/remove-nth-node-from-end-of-list/', tag: 'Two Pointers' },
      { id: 876, title: 'Middle of Linked List', url: 'https://leetcode.com/problems/middle-of-the-linked-list/', tag: 'Fast/Slow' },
      { id: 146, title: 'LRU Cache', url: 'https://leetcode.com/problems/lru-cache/', tag: 'DLL + Hash Map' },
    ],
  },
  {
    ...
    leetcode: [
      ...
      { id: 779, title: 'K-th Symbol in Grammar', url: 'https://leetcode.com/problems/k-th-symbol-in-grammar/', tag: 'Recursion' },
      { id: 50, title: 'Pow(x, n)', url: 'https://leetcode.com/problems/powx-n/', tag: 'Recursion' },
    ],
  },
  {
    ...
    leetcode: [
      ...
      { id: 148, title: 'Sort List', url: 'https://leetcode.com/problems/sort-list/', tag: 'Merge Sort' },
      { id: 215, title: 'Kth Largest Element', url: 'https://leetcode.com/problems/kth-largest-element-in-an-array/', tag: 'Quick Select' },
      { id: 347, title: 'Top K Frequent Elements', url: 'https://leetcode.com/problems/top-k-frequent-elements/', tag: 'Bucket Sort' },
    ],
  },
  {
    ...
    leetcode: [
      ...
      { id: 34, title: 'Find First and Last Position', url: 'https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/', tag: 'Search Range' },
      { id: 153, title: 'Find Minimum in Rotated Array', url: 'https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/', tag: 'Binary Search' },
      { id: 875, title: 'Koko Eating Bananas', url: 'https://leetcode.com/problems/koko-eating-bananas/', tag: 'Binary Search on Answer' },
    ],
  },
]
