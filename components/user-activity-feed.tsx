          ...
          <div className="space-y-8">
            {activities.map((activity) => {
              ...
              const content = (
                <div className="flex items-start">
                  ...
                  <div className="ml-4 space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">{format(activityDate, "PPp")}</p>
                  </div>
                </div>
              );
              ...
              return (
                <div
                  key={activity.id}
                  className="relative pl-8 before:absolute before:left-3.5 before:top-8 before:h-[calc(100%-24px)] before:w-px before:bg-muted"
                >
                  {activityLink ? (
